...
const sampleParts: Record<string, any> = {
  "part-001": {
    id: "part-001",
  ...
  "part-002": {
    ...
    description: "Standard hex socket bolt for mechanical assemblies. Precision threaded for reliable fastening.",
    category: "fasteners",
    material: "Steel",
    process: "CNC",
    basePrice: 4,
  ...
  "part-003": {
    ...
    description: "Protective enclosure for electronics with mounting points and cable management features.",
    category: "enclosures",
    material: "ABS",
    process: "3D Printing",
    basePrice: 28,
  ...
  "part-004": {
    ...
    description: "Precision drive shaft for mechanical assemblies with keyway and thread.",
    category: "shafts",
    material: "Steel 1045",
    process: "CNC Turning",
    basePrice: 45,
  ...
  "part-005": {
    id: "part-005",
    name: "Spur Gear 24T",
    description: "Precision machined spur gear with 24 teeth for power transmission applications.",
    category: "gears",
    material: "Brass",
    process: "CNC Milling",
    basePrice: 56,
  ...
  "part-006": {
    ...
    description: "Heavy-duty L-bracket for structural applications with mounting holes.",
    category: "brackets",
    material: "Steel",
    process: "Sheet Metal",
    basePrice: 18,
...
export async function GET(request: Request, { params }: { params: Promise<{ partId: string }> }) {
  ...
  try {
    const { data, error } = await supabase.from("catalog_parts").select("*").eq("id", partId).single()
