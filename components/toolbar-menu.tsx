  ...
  return (
    <div className="relative">
      <button
        ...
        className={`w-full px-3 py-2 text-left text-sm flex items-center justify-between gap-4 hover:bg-blue-50 transition-colors ${
          ...
          {item.children?.map((subItem, subIdx) => {
            ...
            return subItem.divider ? (
              ...
              <button
                ...
                className={`w-full px-3 py-2 text-left text-sm flex items-center gap-2 hover:bg-blue-50 transition-colors ${
                  subItem.disabled ? 'opacity-50 cursor-not-allowed' : ''
                }`}
              >
                {SubIcon && <SubIcon className="w-4 h-4 text-gray-500" />}
